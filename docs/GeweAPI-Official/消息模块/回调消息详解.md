...
mac(微信回调账户邀请回调信息)=>{
    ...
    "Data": {
        "MsgId": 779314970,
        "FromUserName": {
            "string": "53302137416@chatroom"
        },
        "ToUserName": {
            "string": "wxid_pumxsg3gylx8h12"
        },
        "MsgType": 10002,
        "Content": {
            "string": "53302137416@chatroom:\n<sysmsg type=\"delchatroommember\">\n\t<delchatroommember>\n\t\t<plain><![CDATA[你邀请\"阿科\"加入了群聊  ]]></plain>\n\t\t<text><![CDATA[你邀请\"阿科\"加入了群聊  ]]></text>\n\t\t<link>\n\t\t\t<scene>invite</scene>\n\t\t\t<text><![CDATA[  撤销]]></text>\n\t\t\t<memberlist>\n\t\t\t\t<username><![CDATA[wxid_12fdzgzb1wq6cz21]]></username>\n\t\t\t</memberlist>\n\t\t</link>\n\t</delchatroommember>\n</sysmsg>\n"
        },
        "Status": 4,
        "ImgStatus": 1,
        "ImgBuf": {
        ...
        "CreateTime": 1762336122,
        "MsgSource": "<msgsource>\n\t<tmp_node>\n\t\t<publisher-id></publisher-id>\n\t</tmp_node>\n</msgsource>\n",
        "NewMsgId": 4599658148681373612,
        "MsgSeq": 785170304
    },
    "Wxid": "wxid_pumxsg3gylx8h12"
}

mac(群成员邀请回调信息)=>{
    "wcId": "wxid_yccwpfh1qif322",
    "data": {
        "toUser": "wxid_yccwpfh1qif322",
        "wId": "4186dc7a-57ad-4a19-b737-08d93b41b273",
        "fromUser": "53502137416@chatroom",
        "newMsgId": 7140416899694895696,
        "nickName": "",
        "fromGroup": "53502137416@chatroom",
        "msgId": 1237490653,
        "content": "\"阿登\"邀请\"就叫chéng yǔ chén\"加入了群聊",
        "timestamp": 1762336266
    },
    "messageType": 1,
    "account": "19826013240"
}
